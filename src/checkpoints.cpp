...
namespace Checkpoints
{
    ...
    static MapCheckpoints mapCheckpoints =
        ...
        ( 400, uint256("0x000000000631b20a03e7dcb29e0f81296d9d04239d095515bce79689454041b6") )
        ;
    ...
    bool IsSyncCheckpointTooOld(unsigned int nSeconds)
    {
        ...
        assert(mapBlockIndex.count(hashSyncCheckpoint));
        const CBlockIndex* pindexSync = mapBlockIndex[hashSyncCheckpoint];
        printf("IsSyncCheckpointTooOld(%d)\n", nSeconds);
        printf("  hashSyncCheckpoint: %s\n", hashSyncCheckpoint.ToString().c_str());
        printf("  pindexSync->GetBlockTime(): %ld\n", pindexSync->GetBlockTime());
        printf("  pindexSync->nHeight: %d\n", pindexSync->nHeight);
        printf("  GetAdjustedTime(): %ld\n", GetAdjustedTime());
