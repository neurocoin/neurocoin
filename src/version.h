...
#define NEUROCOIN_VERSION_REVISION    0
#define NEUROCOIN_VERSION_BUILD       0

static const int NEUROCOIN_VERSION =
                           1000000 * NEUROCOIN_VERSION_MAJOR
                         +   10000 * NEUROCOIN_VERSION_MINOR
                         +     100 * NEUROCOIN_VERSION_REVISION
                         +       1 * NEUROCOIN_VERSION_BUILD;
